...
def MyDataLoader(data_path, batch_size, num_classes,
    ...
    TRAIN_TRANSFORM_IMG = torchvision.transforms.Compose([
        ...
        torchvision.transforms.RandomResizedCrop(size=(160, 160), scale=(0.95, 1.0), antialias=True),
        torchvision.transforms.ColorJitter(brightness=0.15, contrast=0.15, saturation=0.15, hue=0.1)
    ])
